...
# CHECK-INST: csrwi	matp, 31
# CHECK-ENC: encoding: [0x73,0xd0,0x0f,0x7c]
csrwi	matp, 0x1f

# CHECK-INST: csrwi	minstmask, 31
# CHECK-ENC: encoding: [0x73,0xd0,0xdf,0x7c]
csrwi	minstmask, 0x1f

# CHECK-INST: csrwi	minstmatch, 31
# CHECK-ENC: encoding: [0x73,0xd0,0xef,0x7c]
csrwi	minstmatch, 0x1f

# CHECK-INST: csrwi	cache_invalidate, 31
# CHECK-ENC: encoding: [0x73,0xd0,0x0f,0x7d]
csrwi	cache_invalidate, 0x1f

# CHECK-INST: csrwi	menable_shadows, 31
# CHECK-ENC: encoding: [0x73,0xd0,0x2f,0x7d]
csrwi	menable_shadows, 0x1f

# CHECK-INST: csrwi	excl_mode, 31
# CHECK-ENC: encoding: [0x73,0xd0,0x3f,0x7d]
csrwi	excl_mode, 0x1f

# CHECK-INST: csrwi	mbusaddr, 31
# CHECK-ENC: encoding: [0x73,0xd0,0x5f,0x7d]
csrwi	mbusaddr, 0x1f

# CHECK-INST: csrwi	mcache_control, 31
# CHECK-ENC: encoding: [0x73,0xd0,0x0f,0x7e]
csrwi	mcache_control, 0x1f

# CHECK-INST: csrwi	evict_sw, 31
# CHECK-ENC: encoding: [0x73,0xd0,0x9f,0x7f]
csrwi	evict_sw, 0x1f

# CHECK-INST: csrwi	flush_sw, 31
# CHECK-ENC: encoding: [0x73,0xd0,0xbf,0x7f]
csrwi	flush_sw, 0x1f

# CHECK-INST: csrwi	lock_sw, 31
# CHECK-ENC: encoding: [0x73,0xd0,0xdf,0x7f]
csrwi	lock_sw, 0x1f

# CHECK-INST: csrwi	unlock_sw, 31
# CHECK-ENC: encoding: [0x73,0xd0,0xff,0x7f]
csrwi	unlock_sw, 0x1f

# CHECK-INST: csrwi	tensor_reduce, 31
# CHECK-ENC: encoding: [0x73,0xd0,0x0f,0x80]
csrwi	tensor_reduce, 0x1f

# CHECK-INST: csrwi	tensor_fma, 31
# CHECK-ENC: encoding: [0x73,0xd0,0x1f,0x80]
csrwi	tensor_fma, 0x1f

# CHECK-INST: csrwi	tensor_conv_size, 31
# CHECK-ENC: encoding: [0x73,0xd0,0x2f,0x80]
csrwi	tensor_conv_size, 0x1f

# CHECK-INST: csrwi	tensor_conv_ctrl, 31
# CHECK-ENC: encoding: [0x73,0xd0,0x3f,0x80]
csrwi	tensor_conv_ctrl, 0x1f

# CHECK-INST: csrwi	tensor_coop, 31
# CHECK-ENC: encoding: [0x73,0xd0,0x4f,0x80]
csrwi	tensor_coop, 0x1f

# CHECK-INST: csrwi	tensor_mask, 31
# CHECK-ENC: encoding: [0x73,0xd0,0x5f,0x80]
csrwi	tensor_mask, 0x1f

# CHECK-INST: csrwi	tensor_quant, 31
# CHECK-ENC: encoding: [0x73,0xd0,0x6f,0x80]
csrwi	tensor_quant, 0x1f

# CHECK-INST: csrwi	tex_send, 31
# CHECK-ENC: encoding: [0x73,0xd0,0x7f,0x80]
csrwi	tex_send, 0x1f

# CHECK-INST: csrwi	tensor_error, 31
# CHECK-ENC: encoding: [0x73,0xd0,0x8f,0x80]
csrwi	tensor_error, 0x1f

# CHECK-INST: csrwi	ucache_control, 31
# CHECK-ENC: encoding: [0x73,0xd0,0x0f,0x81]
csrwi	ucache_control, 0x1f

# CHECK-INST: csrwi	prefetch_va, 31
# CHECK-ENC: encoding: [0x73,0xd0,0xff,0x81]
csrwi	prefetch_va, 0x1f

# CHECK-INST: csrwi	flb, 31
# CHECK-ENC: encoding: [0x73,0xd0,0x0f,0x82]
csrwi	flb, 0x1f

# CHECK-INST: csrwi	fcc, 31
# CHECK-ENC: encoding: [0x73,0xd0,0x1f,0x82]
csrwi	fcc, 0x1f

# CHECK-INST: csrwi	stall, 31
# CHECK-ENC: encoding: [0x73,0xd0,0x2f,0x82]
csrwi	stall, 0x1f

# CHECK-INST: csrwi	tensor_wait, 31
# CHECK-ENC: encoding: [0x73,0xd0,0x0f,0x83]
csrwi	tensor_wait, 0x1f

# CHECK-INST: csrwi	tensor_load, 31
# CHECK-ENC: encoding: [0x73,0xd0,0xff,0x83]
csrwi	tensor_load, 0x1f

# CHECK-INST: csrwi	gsc_progress, 31
# CHECK-ENC: encoding: [0x73,0xd0,0x0f,0x84]
csrwi	gsc_progress, 0x1f

# CHECK-INST: csrwi	tensor_load_l2, 31
# CHECK-ENC: encoding: [0x73,0xd0,0xff,0x85]
csrwi	tensor_load_l2, 0x1f

# CHECK-INST: csrwi	tensor_store, 31
# CHECK-ENC: encoding: [0x73,0xd0,0xff,0x87]
csrwi	tensor_store, 0x1f

# CHECK-INST: csrwi	evict_va, 31
# CHECK-ENC: encoding: [0x73,0xd0,0xff,0x89]
csrwi	evict_va, 0x1f

# CHECK-INST: csrwi	flush_va, 31
# CHECK-ENC: encoding: [0x73,0xd0,0xff,0x8b]
csrwi	flush_va, 0x1f

# CHECK-INST: csrwi	validation0, 31
# CHECK-ENC: encoding: [0x73,0xd0,0x0f,0x8d]
csrwi	validation0, 0x1f

# CHECK-INST: csrwi	validation1, 31
# CHECK-ENC: encoding: [0x73,0xd0,0x1f,0x8d]
csrwi	validation1, 0x1f

# CHECK-INST: csrwi	validation2, 31
# CHECK-ENC: encoding: [0x73,0xd0,0x2f,0x8d]
csrwi	validation2, 0x1f

# CHECK-INST: csrwi	validation3, 31
# CHECK-ENC: encoding: [0x73,0xd0,0x3f,0x8d]
csrwi	validation3, 0x1f

# CHECK-INST: csrwi	lock_va, 31
# CHECK-ENC: encoding: [0x73,0xd0,0xff,0x8d]
csrwi	lock_va, 0x1f

# CHECK-INST: csrwi	unlock_va, 31
# CHECK-ENC: encoding: [0x73,0xd0,0xff,0x8f]
csrwi	unlock_va, 0x1f

# CHECK-INST: csrwi	portctrl0, 31
# CHECK-ENC: encoding: [0x73,0xd0,0xcf,0x9c]
csrwi	portctrl0, 0x1f

# CHECK-INST: csrwi	portctrl1, 31
# CHECK-ENC: encoding: [0x73,0xd0,0xdf,0x9c]
csrwi	portctrl1, 0x1f

# CHECK-INST: csrwi	portctrl2, 31
# CHECK-ENC: encoding: [0x73,0xd0,0xef,0x9c]
csrwi	portctrl2, 0x1f

# CHECK-INST: csrwi	portctrl3, 31
# CHECK-ENC: encoding: [0x73,0xd0,0xff,0x9c]
csrwi	portctrl3, 0x1f

# CHECK-INST: csrwi	fccnb, 31
# CHECK-ENC: encoding: [0x73,0xd0,0x0f,0xcc]
csrwi	fccnb, 0x1f

# CHECK-INST: csrwi	porthead0, 31
# CHECK-ENC: encoding: [0x73,0xd0,0x8f,0xcc]
csrwi	porthead0, 0x1f

# CHECK-INST: csrwi	porthead1, 31
# CHECK-ENC: encoding: [0x73,0xd0,0x9f,0xcc]
csrwi	porthead1, 0x1f

# CHECK-INST: csrwi	porthead2, 31
# CHECK-ENC: encoding: [0x73,0xd0,0xaf,0xcc]
csrwi	porthead2, 0x1f

# CHECK-INST: csrwi	porthead3, 31
# CHECK-ENC: encoding: [0x73,0xd0,0xbf,0xcc]
csrwi	porthead3, 0x1f

# CHECK-INST: csrwi	portheadnb0, 31
# CHECK-ENC: encoding: [0x73,0xd0,0xcf,0xcc]
csrwi	portheadnb0, 0x1f

# CHECK-INST: csrwi	portheadnb1, 31
# CHECK-ENC: encoding: [0x73,0xd0,0xdf,0xcc]
csrwi	portheadnb1, 0x1f

# CHECK-INST: csrwi	portheadnb2, 31
# CHECK-ENC: encoding: [0x73,0xd0,0xef,0xcc]
csrwi	portheadnb2, 0x1f

# CHECK-INST: csrwi	portheadnb3, 31
# CHECK-ENC: encoding: [0x73,0xd0,0xff,0xcc]
csrwi	portheadnb3, 0x1f

# CHECK-INST: csrwi	hartid, 31
# CHECK-ENC: encoding: [0x73,0xd0,0x0f,0xcd]
csrwi	hartid, 0x1f

# CHECK-INST: csrwi	dcache_debug, 31
# CHECK-ENC: encoding: [0x73,0xd0,0x0f,0xfc]
csrwi	dcache_debug, 0x1f