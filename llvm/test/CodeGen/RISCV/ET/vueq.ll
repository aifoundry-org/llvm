...
define void @ueq(%IVEC* %result, %VEC* %0, %VEC* %1) {
  %x = load %VEC, %VEC* %0
  %y = load %VEC, %VEC* %1
  %cmp = fcmp ueq %VEC %x, %y
...
; CHECK-NEXT:	feqm.ps	[[V4:m[0-9]+]], [[V0]], [[V2]]
; CHECK-NEXT:	feqm.ps	[[V5:m[0-9]+]], [[V2]], [[V2]]
; CHECK-NEXT:	feqm.ps	[[V6:m[0-9]+]], [[V0]], [[V0]]
; CHECK-NEXT:	maskand	[[V5]], [[V6]], [[V5]]
; CHECK-NEXT:	masknot	[[V5]], [[V5]]
; CHECK-NEXT:	fbci.pi	[[V0:f(a|s|t)[0-9]+]], 0
; CHECK-NEXT:	maskor  m0, [[V4]], [[V5]]
; CHECK-NEXT:	fbci.pi	[[V0]], -1
; CHECK-NEXT:	fsq2  [[V0]], 0([[V7:(a|s|t)[0-9]+]])
