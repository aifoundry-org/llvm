...
declare void @llvm.masked.scatter.v8i32.v8p0i32(%VEC, %PVEC , i32 immarg, %MASK)

define void @mscatter(%VEC* %result,
                    %VEC* %0,
		    %VEC* %1,
		    i32 * %2) {
  %x = load %VEC, %VEC* %0
  ...
  tail call void @llvm.masked.scatter.v8i32.v8p0i32(%VEC %x, %PVEC %array, i32 4, %MASK %m)
  ret void
}
...
; CHECK-NEXT:	fscw.ps	[[V0]], [[V6]]([[V8:(a|s|t)[0-9]+]])
