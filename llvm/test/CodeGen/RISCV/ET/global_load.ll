...
define signext i32 @_Z11global_loadPU3AS2c(i8 addrspace(2)* nocapture readonly %0) local_unnamed_addr #0 {
  %2 = load i8, i8 addrspace(2)* %0, align 1, !tbaa !5
  %3 = zext i8 %2 to i32
  ret i32 %3
}

; Function Attrs: norecurse nounwind readonly
define signext i32 @_Z11global_loadPU3AS2s(i16 addrspace(2)* nocapture readonly %0) local_unnamed_addr #0 {
  %2 = load i16, i16 addrspace(2)* %0, align 2, !tbaa !8
  %3 = sext i16 %2 to i32
  ret i32 %3
}

; Function Attrs: norecurse nounwind readonly
define signext i32 @_Z11global_loadPU3AS2i(i32 addrspace(2)* nocapture readonly %0) local_unnamed_addr #0 {
  %2 = load i32, i32 addrspace(2)* %0, align 4, !tbaa !10
  ret i32 %2
}

; Function Attrs: norecurse nounwind readonly
define signext i32 @_Z11global_loadPU3AS2h(i8 addrspace(2)* nocapture readonly %0) local_unnamed_addr #0 {
  %2 = load i8, i8 addrspace(2)* %0, align 1, !tbaa !5
  %3 = zext i8 %2 to i32
  ret i32 %3
}
...
; Function Attrs: norecurse nounwind readonly
define signext i32 @_Z11global_loadPU3AS2t(i16 addrspace(2)* nocapture readonly %0) local_unnamed_addr #0 {
  %2 = load i16, i16 addrspace(2)* %0, align 2, !tbaa !8
  %3 = zext i16 %2 to i32
  ret i32 %3
}
...
; Function Attrs: norecurse nounwind readonly
define signext i32 @_Z11global_loadPU3AS2j(i32 addrspace(2)* nocapture readonly %0) local_unnamed_addr #0 {
  %2 = load i32, i32 addrspace(2)* %0, align 4, !tbaa !10
  ret i32 %2
}
