...
declare void @llvm.masked.store.v8i32.p1v8i32(%VEC, %VEC addrspace(1)*, i32 immarg, %MASK);

define void @mstore(%VEC addrspace(1)* %result,
                    %VEC* %0,
		    %VEC* %1){
entry:
  %x = load %VEC, %VEC* %0
  %y = load %VEC, %VEC* %1
  %m = icmp slt %VEC %x, %y
  tail call void @llvm.masked.store.v8i32.p1v8i32(%VEC %x, %VEC addrspace(1)* %result, i32 4, %MASK %m)
  ret void
}
...
; CHECK-NEXT:	fscwl.ps	[[V0]], [[V12]]([[V14:(a|s|t)[0-9]+]])
