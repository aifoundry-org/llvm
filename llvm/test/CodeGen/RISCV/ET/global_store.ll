...
define void @_Z12global_storePU3AS2cc(i8 addrspace(2)* nocapture %0, i8 zeroext %1) local_unnamed_addr #0 {
  store i8 %1, i8 addrspace(2)* %0, align 1, !tbaa !5
  ret void
}

; Function Attrs: nofree norecurse nounwind writeonly
define void @_Z12global_storePU3AS2ss(i16 addrspace(2)* nocapture %0, i16 signext %1) local_unnamed_addr #0 {
  store i16 %1, i16 addrspace(2)* %0, align 2, !tbaa !8
  ret void
}

; Function Attrs: nofree norecurse nounwind writeonly
define void @_Z12global_storePU3AS2ii(i32 addrspace(2)* nocapture %0, i32 signext %1) local_unnamed_addr #0 {
  store i32 %1, i32 addrspace(2)* %0, align 4, !tbaa !10
  ret void
}
